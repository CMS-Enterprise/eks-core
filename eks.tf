...
module "eks_addons" {
  ...
  karpenter_nodepool_kubelet                           = var.kp_nodepool_kubelet
  karpenter_nodepool_labels                            = var.kp_nodepool_labels
  karpenter_nodepool_limits                            = var.kp_nodepool_limits
  karpenter_nodepool_name                              = var.kp_nodepool_name
  karpenter_nodepool_requirements                      = var.kp_nodepool_requirements
  karpenter_nodepool_startup_taints                    = var.kp_nodepool_startup_taints
  karpenter_nodepool_taints                            = var.kp_nodepool_taints
  karpenter_nodepool_weight                            = var.kp_nodepool_weight
